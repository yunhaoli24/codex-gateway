...
<template>
  <PinInputInput
    ...
    :class="
      cn(
        'border-input bg-surface focus:border-ring focus:ring-ring/50 focus:aria-invalid:ring-destructive/20 aria-invalid:border-destructive focus:aria-invalid:border-destructive relative flex h-9 w-9 items-center justify-center border-y border-r text-sm shadow-xs transition-all outline-none text-center first:rounded-l-md first:border-l last:rounded-r-md focus:z-10 focus:ring-3',
        props.class,
      )
    "
  />
