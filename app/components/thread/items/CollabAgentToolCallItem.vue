      ...
      <CollapsibleContent>
        <div class="space-y-3 border-t border-black/10 px-3 py-3 text-sm leading-6">
          ...
          <div v-if="item.receiverThreadIds?.length" class="space-y-1">
            <div class="text-xs font-medium uppercase text-[#9aa1a6]">{{ t('app.receiverThreads') }}</div>
            <div
          ...
          <div v-if="agents.length" class="space-y-2">
            <div class="text-xs font-medium uppercase text-[#9aa1a6]">{{ t('app.agentStates') }}</div>
            <div
            ...
            >
              ...
              <div class="mt-1 flex items-center gap-2 text-xs text-[#8d9499]">
                ...
                <span v-if="(state as any).message" class="truncate">{{ (state as any).message }}</span>
              </div>
            </div>
          </div>
        </div>
