...
const elapsedMs = computed(() => (inProgress.value ? now.value : completedAt.value ?? now.value) - startedAt.value)
    ...
    <div class="flex items-start gap-2">
      ...
      <div class="min-w-0 flex-1">
        <div class="mb-1 flex items-center gap-2 text-xs text-[#8d9499]">
          ...
          <span class="rounded-full bg-white/80 px-2 py-0.5 font-mono text-[0.6875rem] text-[#6f767d]">{{ timeLabel }}</span>
        </div>
