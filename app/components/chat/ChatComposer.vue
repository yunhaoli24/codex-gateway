...
<template>
  <div class="shrink-0 bg-gradient-to-t from-white via-white to-white/75 px-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] md:px-[clamp(1rem,3vw,2rem)] md:pb-[clamp(0.5rem,1.4vh,1rem)]">
    <div class="mx-auto w-full max-w-3xl">
      <div class="rounded-[1.35rem] border border-black/10 bg-white p-2 shadow-lg shadow-black/10 md:rounded-3xl md:p-[clamp(0.45rem,1vw,0.7rem)]">
        <input
          ref="uploadInputRef"
          class="hidden"
          type="file"
        ...
        <Textarea
          ...
          @paste="handlePaste"
        />
        <div class="flex flex-col gap-2 pt-1.5 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
