...
const activeApprovalOption = computed(() => approvalOptions.find((option) => option.value === props.modelValue) ?? approvalOptions.at(-1)!)
</script>

<template>
  <Popover>
    <PopoverTrigger as-child>
      <Button type="button" variant="ghost" size="lg" class="h-10 shrink-0 gap-2 px-2 text-sm font-normal text-[#858b91] hover:bg-black/[0.04] hover:text-[#4f575e] md:text-base">
