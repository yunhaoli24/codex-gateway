...
import { mergeThreadSettings, messageFromError, normalizeThreadSettings, pinnedKey } from '../thread-utils'

export function createThreadSettingsActions(ctx: GatewayStoreContext) {
  return {
    setThreadSettings(hostId: number, threadId: string, settings: ThreadSettingsState | null | undefined) {
